...
(function() {
	...
	XML3DShaderRenderAdapter.prototype.notifyChanged = function(evt) {
		//TODO: pass change to renderer so the shader can be updated
	...
	XML3DShaderRenderAdapter.prototype.isEmpty = function(obj) {
		for (var p in obj) {
			return false;
		}
		return true;
	...
	XML3DShaderRenderAdapter.prototype.getStandardShaderSource = function(scriptURL, sources) {
	...
	XML3DShaderRenderAdapter.prototype.createShaderProgram = function(sources) {
		return this.shaderHandler.createShaderFromSources(sources);
	};
	
	XML3DShaderRenderAdapter.prototype.bindProgram = function() {	
	...
	XML3DShaderRenderAdapter.prototype.enable = function(globalUniforms) {
		this.bindProgram();	
		//this.setUniformVariables(globalUniforms);
		this.bindSamplers();
	};
	
	XML3DShaderRenderAdapter.prototype.disable = function() {
		this.unbindSamplers();
	};
	
	XML3DShaderRenderAdapter.prototype.setUniformVariables = function(globalUniforms) {
		var dataTable = this.dataAdapter.createDataTable();
	...
	XML3DShaderRenderAdapter.prototype.unbindSamplers = function() {
		for (var name in this.textures) {
			var tex = this.textures[name];
