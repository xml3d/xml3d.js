...
XML3D.webgl.BoundingBox.prototype.getAsXML3DBox = function() {
    return new window.XML3DBox(this.min, this.max);
};

XML3D.webgl.BoundingBox.prototype.extendWithBox = function(that) {
...
XML3D.webgl.BoundingBox.prototype.extendWithVertices = function(v) {
...
XML3D.webgl.BoundingBox.prototype.makeAxisAligned = (function() {
...
XML3D.webgl.BoundingBox.prototype.reset = function() {
...
XML3D.webgl.BoundingBox.prototype.isEmpty = function() {
    return (this.min[0] > this.max[0] || this.min[1] > this.max[1] || this.min[2] > this.max[2]);
};

XML3D.webgl.BoundingBox.prototype.getVertices = function() {
...
XML3D.webgl.BoundingBox.prototype.getZMinMax = function(mat) {
