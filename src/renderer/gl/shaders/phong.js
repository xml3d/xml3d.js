XML3D.shaders.register("phong", {
    ...
    vertex : [
        ...
        "varying vec3 pointLightShadowMapDirection[MAX_POINTLIGHTS];",
        "#endif",
        ...
        "       pointLightShadowMapDirection[i] = worldPosition - pointLightPosition[i];",
        "    }",
        "#endif",
        "#if MAX_SPOTLIGHTS > 0 && HAS_SPOTLIGHT_SHADOWMAPS",
    ...
    fragment : [
        ...
        "           //vec3 shadowMapDir =  fragWorldPosition - pointLightPosition[i];", // moved to vert-shader : shadowMapDir becomes -> pointLightShadowMapDirection
        "           float lsDepth = vecToDepth(pointLightShadowMapDirection[i], pointLightNearFar[i].x, pointLightNearFar[i].y );", //TODO check if this calculation can be done in vert shader aswell
