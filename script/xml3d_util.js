 ...
 *            'scaleOrientation'
 */
org.xml3d.util.X3DOrientationInterpolation = function(inode, tnode, tfield) {
	this.inodeId = inode;
	this.tnodeId = tnode;
	this.tnode = null;
...
org.xml3d.util.X3DOrientationInterpolation.prototype.initialize = function() {
	...
	var inode = org.xml3d.util.X3DOrientationInterpolation.getElementById(
			this.inodeId, org.xml3d.x3dNS);
	if (!inode) {
		org.xml3d.debug.logError("Can't find X3D node: " + this.inodeId);
		return;
	}
	this.tnode = org.xml3d.util.X3DOrientationInterpolation.getElementById(
			this.tnodeId, org.xml3d.xml3dNS);
	if (!this.tnode) {
		org.xml3d.debug.logError("Can't find Xml3d node: " + this.tnodeId);
		return;
	}
	this.keyValue = org.xml3d.dataTypes.MFRotation.parse(inode
...
org.xml3d.util.X3DOrientationInterpolation.prototype.interpolate = function(t,
		interp) {
	if (t <= this.key[0])
...
org.xml3d.util.X3DOrientationInterpolation.getElementById = function(id,
		namespace) {
