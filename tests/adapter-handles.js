...
test("Get Local Adapters", function() {
    ...
    handle = XML3D.base.resourceManager.getAdapterHandle(this.doc.URL, "#shader1", XML3D.webgl, canvasId);
    ...
    handle = XML3D.base.resourceManager.getAdapterHandle(this.doc.URL, "#group1", XML3D.webgl, canvasId);
    ...
    handle = XML3D.base.resourceManager.getAdapterHandle(this.doc.URL, "#mesh1", XML3D.webgl, canvasId);
