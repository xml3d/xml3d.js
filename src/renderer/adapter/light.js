...
// Adapter for <light>
xml3d.webgl.XML3DLightRenderAdapter = function(factory, node) {
...
xml3d.webgl.XML3DLightRenderAdapter.prototype = new xml3d.webgl.RenderAdapter();
xml3d.webgl.XML3DLightRenderAdapter.prototype.constructor = xml3d.webgl.XML3DLightRenderAdapter;

xml3d.webgl.XML3DLightRenderAdapter.prototype.notifyChanged = function(e) {
...
xml3d.webgl.XML3DLightRenderAdapter.prototype.internalNotifyChanged = function(what, newValue) {
...
xml3d.webgl.XML3DLightRenderAdapter.prototype.getParameters = function(modelViewMatrix) {
...
xml3d.webgl.XML3DLightRenderAdapter.prototype.getLightShader = function() {
	if (!this.lightShader) {
...
xml3d.webgl.XML3DLightRenderAdapter.prototype.dispose = function() {
	this.isValid = false;
};
