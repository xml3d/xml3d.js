XML3D.shaders.register("diffuse", {
    ...
    fragment : [
        ...
        "uniform bool pointLightVisibility[MAX_POINTLIGHTS];",
        "#endif",
        ...
        "uniform bool directionalLightVisibility[MAX_DIRECTIONALLIGHTS];",
        "#endif",
        ...
        "uniform bool spotLightVisibility[MAX_SPOTLIGHTS];",
        ...
        "      if (!directionalLightVisibility[i])",
        "         continue;",
